class Player {
    ...
    update(input) {
        if(input.left.isDown) {
            this.sprite.setVelocityX(-180).setFlipX(true);
            this.sprite.body.onFloor() && this.sprite.play('run', true);
            this.sprite.body.onFloor() && this.sprite.isDed && this.sprite.play('die', true);
            
            this.scene.cameras.main.stopFollow(this.sprite);
        } else if(input.right.isDown) {
            this.sprite.setVelocityX(180).setFlipX(false);
            this.sprite.body.onFloor() && this.sprite.play('run', true);
            this.sprite.body.onFloor() && this.sprite.isDed && this.sprite.play('die', true);
