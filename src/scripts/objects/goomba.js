import increaseScore from "../ui elements/score.js";
...
class Goomba {
    constructor(scene) {
        ...
        const goombaObj = this.scene.map.getObjectLayer('goomba').objects;

        for(const goomba of goombaObj) {
